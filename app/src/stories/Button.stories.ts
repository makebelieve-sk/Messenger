...
const meta = {
  ...
  // Используйте `fn` для отслеживания аргумента onClick, который появится на панели действий после вызова.: https://storybook.js.org/docs/essentials/actions#action-args
  args: { onClick: fn() },
