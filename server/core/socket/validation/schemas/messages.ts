...
export const emitMessagesSchema = {
    ...
    [SocketActions.DELETE_MESSAGE]: z.object({ messageId: z.string().min(1, t("validation.schema.error.required_message_id")) }),
    [SocketActions.DELETE_CHAT]: z.object({ chatId: z.string().min(1, t("validation.schema.error.required_chat_id")) }),
