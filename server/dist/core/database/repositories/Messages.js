...
const message_1 = __importDefault(require("@core/database/models/message"));
...
class Messages {
    constructor(_sequelize) {
        ...
        this._model = (0, message_1.default)(this._sequelize);
    }
    get model() {
        return this._model;
    }
    async create({ creationAttributes, transaction }) {
        try {
            ...
            throw new index_1.RepositoryError((0, i18n_1.t)("repository.error.internal_db", { repo: "Messages", method: "create" }) + error.message);
        }
    }
}
