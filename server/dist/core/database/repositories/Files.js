...
const file_1 = __importDefault(require("@core/database/models/file"));
...
class Files {
    constructor(_sequelize) {
        ...
        this._model = (0, file_1.default)(this._sequelize);
    }
    get model() {
        return this._model;
    }
    async create({ creationAttributes, transaction }) {
        try {
            ...
            throw new index_1.RepositoryError((0, i18n_1.t)("repository.error.internal_db", { repo: "Files", method: "create" }) + error.message);
        }
    }
}
