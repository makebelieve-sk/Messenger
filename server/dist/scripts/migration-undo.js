...
async function undoMigration(migrationFileName) {
    try {
        const mirgationPath = path_1.default.join(__dirname, "../", MIGRATION_DIR, migrationFileName);
...
//# sourceMappingURL=migration-undo.js.map