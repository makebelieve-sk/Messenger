#!/usr/bin/env bash
# Проверка наличия services/main/certs/localhost.pem и services/main/certs/localhost-key.pem
...
if [ ${#missing[@]} -gt 0 ]; then
    ...
    echo
    echo "В папке services/main сгенерируйте локальные сертификаты командой:"
